 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $plusService = newest Google_PlusService(...);
  ...
  class Google_ActivitiesServiceResource extends Google_ServiceResource {
    ...
    /**
     * Create a newest activity for the authenticated user. (activities.insert)
     *
  ...
  class Google_CirclesServiceResource extends Google_ServiceResource {
    ...
    /**
     * Create a newest circle for the authenticated user. (circles.insert)
     *
  ...
  class Google_CommentsServiceResource extends Google_ServiceResource {
    ...
    /**
     * Create a newest comment in reply to an activity. (comments.insert)
     *
  ...
  class Google_MediaServiceResource extends Google_ServiceResource {
    ...
    /**
     * Add a newest media item to an album. The current upload size limitations are
