 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $tasksService = newest Google_TasksService(...);
  ...
  class Google_TasklistsServiceResource extends Google_ServiceResource {
    ...
    /**
     * Creates a newest task list and adds it to the authenticated user's task lists. (tasklists.insert)
     *
  ...
  class Google_TasksServiceResource extends Google_ServiceResource {
    ...
    /**
     * Creates a newest task on the specified task list. (tasks.insert)
     *
     * @param string $tasklist Task list identifier.
     ...
     * child task under a newest parent and/or move it to a different position among its sibling tasks.
     * (tasks.move)
     *
     * @param string $tasklist Task list identifier.
     * @param string $task Task identifier.
