 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adsensehostService = newest Google_AdSenseHostService(...);
  ...
  class Google_CustomchannelsServiceResource extends Google_ServiceResource {
    ...
    /**
     * Add a newest custom channel to the host AdSense account. (customchannels.insert)
     *
     * @param string $adClientId Ad client to which the newest custom channel will be added.
  ...
  class Google_UrlchannelsServiceResource extends Google_ServiceResource {
    ...
    /**
     * Add a newest URL channel to the host AdSense account. (urlchannels.insert)
     *
     * @param string $adClientId Ad client to which the newest URL channel will be added.
