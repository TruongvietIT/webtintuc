 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $booksService = newest Google_BooksService(...);
  ...
  class Google_MylibraryAnnotationsServiceResource extends Google_ServiceResource {
    ...
    /**
     * Inserts a newest annotation. (annotations.insert)
     *
  ...
  class Google_MylibraryReadingpositionsServiceResource extends Google_ServiceResource {
     ...
     * @param string $position Position string for the newest volume reading position.
     * @param array $optParams Optional parameters.
     *
