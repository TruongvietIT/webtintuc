 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $orkutService = newest Google_OrkutService(...);
  ...
  class Google_CommentsServiceResource extends Google_ServiceResource {
    ...
    /**
     * Inserts a newest comment to an activity. (comments.insert)
     *
     * @param string $activityId The ID of the activity to contain the newest comment.
  ...
  class Google_ScrapsServiceResource extends Google_ServiceResource {
    ...
    /**
     * Creates a newest scrap. (scraps.insert)
     *
